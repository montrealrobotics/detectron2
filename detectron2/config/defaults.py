...
## loss type regression when DETECTOR_TYPE is probabilistic: ['smooth_l1', loss_att', 'loss_cal', 'mahalanobis_attenuation', 'kl_divergence_batch_loss', 'kl_batch_plus_loss_att']
