...
class DefaultPredictor:
	...
	# @torch.no_grad()
	# def __call_original__(self, original_image):
	#     """
	#     Args:
	...
	def __call__(self, original_image):
		...
		if self.structured_edge_response and self.input_type != 'BGR':
			image = utils.read_custom_image(original_image, format=self.input_format, model = self.edge_model, input_type = self.input_type)
		else:
			image = utils.read_image(original_image, format=self.input_format)
