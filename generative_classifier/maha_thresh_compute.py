...
input_data = h5py.File('/network/tmp1/bhattdha/detectron2_coco/coco_probabilistic_from_coco_xyxy_deterministic_full_frozen/embeddings_storage/final_data.h5', 'r')
...
for class_label in class_labels:
	...
	print('Training Class# {}, number of data points: {}'.format(class_label, len(indices)))
	data = X[indices,:]
...
np.save('maha_thresh_coco.npy', final_dict)
import ipdb; ipdb.set_trace()