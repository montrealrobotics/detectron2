...
model_paths = sorted(glob.glob('/network/tmp1/bhattdha/detectron2_coco/coco_all_classes_loss_attenuation/model_0*'))
...
# import ipdb; ipdb.set_trace()
    ...
    evaluator = COCOEvaluator("coco_2017_val", cfg, False, output_dir="coco_all_classes_loss_attenuation/" + model_name)
